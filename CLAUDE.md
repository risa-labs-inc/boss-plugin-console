...
**Console (Dynamic)** (`ai.rever.boss.plugin.dynamic.console`) is a dynamic plugin for the BOSS desktop application.

Displays captured stdout/stderr logs in a side panel

- **Plugin ID**: `ai.rever.boss.plugin.dynamic.console`
- **Main Class**: `ai.rever.boss.plugin.dynamic.console.ConsoleDynamicPlugin`
- **API Version**: 1.0.20
